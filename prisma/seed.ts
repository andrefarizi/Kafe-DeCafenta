    ...
    data: [
      {
        ...
        price: 25000,
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Nasi_Goreng_Kampung_%2811967588375%29.jpg/960px-Nasi_Goreng_Kampung_%2811967588375%29.jpg',
        isAvailable: true,
        isPromo: true,
      },
      {
        ...
        price: 20000,
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/24/Ayam_geprek.png',
        isAvailable: true,
        isPromo: false,
      },
    ],
  ...
  await prisma.menu.createMany({
    data: [
      ...
      },
      {
        ...
        price: 18000,
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Mi_Goreng_GM.jpg/960px-Mi_Goreng_GM.jpg',
        isAvailable: true,
        isPromo: true,
      },
    ],
  ...
  await prisma.menu.createMany({
    data: [
      ...
      },
      {
        ...
        price: 12000,
        imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Cha_yen.JPG/960px-Cha_yen.JPG',
        isAvailable: true,
        isPromo: false,
      },
    ],
