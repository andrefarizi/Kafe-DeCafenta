                ...
                <div className="p-5 w-full overflow-y-auto">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    <span className="bg-[#8A0000] text-white text-[8px] px-1.5 py-0.5 rounded font-bold uppercase">Dimasak</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-lg border border-1 border-[#8A0000] p-6 mb-6 relative shadow-sm w-full">
                        ...
                        <div className="relative flex justify-between px-0 mb-8 z-0">
                            ...
                            <div className="absolute left-[12.49%] w-[25%] top-[34px] -translate-y-1/2 h-2.5 bg-gradient-to-r from-[#FFC700] to-[#8B1A1A] z-[-1]" style={{ left: '34px', width: 'calc((100% - 68px) * 0.33)' }}></div>
