                ...
                <div className="p-5 w-full overflow-y-auto">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    <span style={{ backgroundColor: '#16C222' }} className="text-white text-[8px] px-1.5 py-0.5 rounded font-bold uppercase">Selesai</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative flex justify-between px-0 mb-8 z-0">
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    background: 'linear-gradient(to right, #FFC700 0%, #8B1A1A 33%, #2563EB 66%, #22C55E 100%)'
                                }}
                            ></div>
                            ...
                            {/* Step 4: Selesai */}
                            <div className="flex flex-col items-center w-fit">
                                <div className="w-[68px] h-[68px] rounded-full border-[4px] border-[#22C55E] bg-white p-[3px] flex items-center justify-center z-10">
                    ...
                    <div className="overflow-x-auto mb-6 w-full text-left">
                        ...
                        <div className="mt-6 flex flex-col items-end gap-2">
                            ...
                            <Link href="/customer/invoice" className="flex items-center gap-4 bg-[#8A0000] text-white px-4 py-2 rounded-lg hover:bg-red-900 transition-all shadow-md">
                        ...
                        <div className="flex flex-col min-h-[500px]">
                            <div className="py-3 flex justify-center items-center">
                                <h2 className="text-sm md:text-xl font-bold text-black text-center tracking-wide">
