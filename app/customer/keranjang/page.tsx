        ...
        {step === "editNote" && (
          <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="bg-[#F8F9FA] border-[3px] border-[#8B0000] rounded-[36px] w-full max-w-[650px] p-10 shadow-2xl">
              ...
              <div className="flex gap-4">
                <button onClick={() => setStep("")} className="flex-1 border-[1.5px] border-[#8B0000] text-[#8B0000] py-4 rounded-[14px] font-extrabold text-[18px] hover:bg-red-50 transition-colors">Batalkan</button>
                <button
                  disabled={isPending}
