      ...
      <div className="flex-1">
        ...
        <main className="px-[26px] pt-[28px]">
          ...
          <div className="mb-[34px] flex items-center justify-center gap-[38px]">
            <Tab active icon={<Image src="/group 135.png" alt="Semua" width={24} height={24} />} text="Semua" width="w-[170px]" />
            ...
            <Tab icon={<Image src="/Food Icon Illustrations Kit (3).png" alt="Siap Diambil" width={24} height={24} />} text="Siap Diambil" width="w-[190px]" />
...
function PageBtn({
  ...
  return (
    <button
      className={`flex items-center justify-center h-[46px] rounded-md shadow-[0_4px_8px_rgba(0,0,0,0.18)]
      ${
        wide
