...
export default async function KasirInvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <InvoiceClient order={order} backHref={`/kasir/daftar-pesanan/detail/${orderId}`} />;
}
