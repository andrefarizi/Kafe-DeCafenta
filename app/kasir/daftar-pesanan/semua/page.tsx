...
const orderList: OrderData[] = [
  ...
  { id: '#DCF001', nama: 'Andre Ganteng', jumlah: '1 Menu', harga: 'Rp 20.000', status: 'Masuk', tanggal: '8 Apr 2026', waktu: '10 : 30' },
  { id: '#DCF001', nama: 'Andre Ganteng', jumlah: '1 Menu', harga: 'Rp 20.000', status: 'Masuk', tanggal: '8 Apr 2026', waktu: '10 : 30' },
  { id: '#DCF001', nama: 'Andre Ganteng', jumlah: '1 Menu', harga: 'Rp 20.000', status: 'Dimasak', tanggal: '8 Apr 2026', waktu: '10 : 30' },
  { id: '#DCF001', nama: 'Andre Ganteng', jumlah: '1 Menu', harga: 'Rp 20.000', status: 'Selesai', tanggal: '8 Apr 2026', waktu: '10 : 30' },
  { id: '#DCF001', nama: 'Andre Ganteng', jumlah: '1 Menu', harga: 'Rp 20.000', status: 'Siap Diambil', tanggal: '8 Apr 2026', waktu: '10 : 30' },
];

const tabs = [
  { label: 'Semua', icon: '/Group 135.png', href: '/kasir/daftar-pesanan/semua' },
  { label: 'Masuk', icon: '/Food Icon Illustrations Kit (1).png', href: '/kasir/daftar-pesanan/masuk' },
  { label: 'Dimasak', icon: '/Food Icon Illustrations Kit (2).png', href: '/kasir/daftar-pesanan/dimasak' },
  { label: 'Siap Diambil', icon: '/Food Icon Illustrations Kit (3).png', href: '/kasir/daftar-pesanan/siap-diambil' },
  { label: 'Selesai', icon: '/Food Icon Illustrations Kit (4).png', href: '/kasir/daftar-pesanan/selesai' },
];

export default function PesananMasuk() {
  const [activeTab, setActiveTab] = useState('Semua');

  // Fungsi pembantu untuk warna teks status
  const getStatusColor = (status: StatusPesanan) => {
    switch (status) {
      case 'Masuk': return 'text-[#FFC700]';
      case 'Dimasak': return 'text-[#8B1A1A]';
      case 'Siap Diambil': return 'text-[#3B82F6]'; // Biru
      case 'Selesai': return 'text-[#22C55E]'; // Hijau
  ...
  const getDetailHref = (status: StatusPesanan) => {
    switch (status) {
      case 'Masuk':       return '/kasir/daftar-pesanan/masuk/detail';
      case 'Dimasak':     return '/kasir/daftar-pesanan/dimasak/detail';
      case 'Siap Diambil': return '/kasir/daftar-pesanan/siap-diambil/detail';
      case 'Selesai':     return '/kasir/daftar-pesanan/selesai/detail';
      default:            return '/kasir/daftar-pesanan/masuk/detail';
    }
  };
