...
// --- Dummy Data (Difilter khusus status "Siap Diambil" sesuai mockup) ---
...
export default function PesananSiapDiambilFiltered() {
  // Set default state ke "Siap Diambil" agar sesuai dengan gambar
  const [activeTab, setActiveTab] = useState('Siap Diambil');

  const getStatusColor = (status: StatusPesanan) => {
    switch (status) {
      case 'Masuk': return 'text-[#FFC700]';
      case 'Dimasak': return 'text-[#8B1A1A]'; 
      case 'Siap Diambil': return 'text-[#2563EB]'; // Biru (mirip dengan Tailwind blue-600)
                ...
                <tr key={index} className="border-b-2 border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-5 px-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        href="/kasir/daftar-pesanan/siap-diambil/detail"
