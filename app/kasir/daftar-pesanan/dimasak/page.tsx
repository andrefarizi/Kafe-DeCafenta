...
// --- Dummy Data (Difilter khusus status "Dimasak" sesuai mockup) ---
...
export default function PesananDimasakFiltered() {
  // Set default state ke "Dimasak" agar sesuai dengan gambar
  const [activeTab, setActiveTab] = useState('Dimasak');

  const getStatusColor = (status: StatusPesanan) => {
    switch (status) {
      case 'Masuk': return 'text-[#FFC700]';
      case 'Dimasak': return 'text-[#8B1A1A]'; // Sesuai dengan mockup
                ...
                <tr key={index} className="border-b-2 border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-5 px-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Link 
                        href="/kasir/daftar-pesanan/dimasak/detail"
