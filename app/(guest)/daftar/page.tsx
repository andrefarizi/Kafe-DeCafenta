...
export default function PesananPage() {
  ...
  const handleOpenIntro = (event: React.FormEvent<HTMLFormElement>) => {
    if (validationErrors.name || validationErrors.email || validationErrors.password) {
      ...
      setErrorMsg('Mohon perbaiki kesalahan pada form sebelum mendaftar.');
      return;
    }
            ...
            <div className="relative flex flex-col">
              <div className="relative flex items-center">
                ...
                <input 
                  ...
                  required
                  placeholder="Nama" 
                  className={`w-full pl-14 pr-4 py-3 rounded-full bg-[#f4eae1]/80 border focus:outline-none text-gray-700 placeholder-gray-400 shadow-inner transition-colors ${validationErrors.name ? 'border-red-500 focus:ring-2 focus:ring-red-400' : 'border-[#f4d03f] focus:ring-2 focus:ring-[#f4d03f]'}`}
                />
              </div>
              {validationErrors.name && (
                <span className="text-red-500 text-xs font-bold mt-1 ml-4">{validationErrors.name}</span>
              )}
            </div>
            ...
            <div className="relative flex flex-col">
              <div className="relative flex items-center">
                <input 
                  ...
                  required
                  placeholder="Email" 
                  className={`w-full pr-14 pl-6 py-3 rounded-full bg-[#f4eae1]/80 border focus:outline-none text-gray-700 placeholder-gray-400 shadow-inner transition-colors ${validationErrors.email ? 'border-red-500 focus:ring-2 focus:ring-red-400' : 'border-[#f4d03f] focus:ring-2 focus:ring-[#f4d03f]'}`}
                />
            ...
            <div className="relative flex flex-col">
              <div className="relative flex items-center">
                ...
                <input 
                  ...
                  className={`w-full pl-14 pr-12 py-3 rounded-full bg-[#f4eae1]/80 border focus:outline-none text-gray-700 placeholder-gray-400 shadow-inner transition-colors ${validationErrors.password ? 'border-red-500 focus:ring-2 focus:ring-red-400' : 'border-[#f4d03f] focus:ring-2 focus:ring-[#f4d03f]'}`}
                />
                <button
                  type="button"
