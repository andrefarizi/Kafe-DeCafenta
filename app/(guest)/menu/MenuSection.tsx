      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-2xl p-4 md:p-5 shadow-lg border border-transparent flex flex-col group hover:shadow-[0px_14px_28px_rgba(0,0,0,0.14)] transition-shadow"
            >
