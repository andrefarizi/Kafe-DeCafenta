...
export default function DetailPesananSelesai() {
  return (
    <div className="min-h-screen bg-white p-4 md:p-8 font-sans text-gray-900 max-w-4xl mx-auto">
      ...
      <div className="border border-[#8B1A1A] rounded-2xl p-6 flex justify-between items-center mb-6">
        ...
        <div className="text-right flex flex-col items-end">
          ...
          <span className="bg-[#22C55E] text-white font-extrabold text-sm px-4 py-1 rounded-sm shadow-sm">
            Selesai
          </span>
        </div>
      </div>
      ...
      <div className="border border-[#8B1A1A] rounded-2xl p-6 mb-8 relative">
        ...
        {/* Tracker */}
        <div className="relative flex justify-between items-center px-4 md:px-12 mb-2 z-0">
          ...
          <div className="absolute left-10 right-10 md:left-16 md:right-16 top-1/2 -translate-y-1/2 h-2 flex -z-10">
            ...
            <div className="h-full w-1/3 bg-gradient-to-r from-[#2563EB] to-[#22C55E]"></div>
          </div>
          ...
          <div className="flex flex-col items-center bg-white px-2">
            ...
            <span className="text-xs font-extrabold text-black">Dimasak</span>
          </div>
          ...
          <div className="flex flex-col items-center bg-white px-2">
            ...
            <span className="text-xs font-extrabold text-black">Siap Diambil</span>
          </div>
          ...
          <div className="flex flex-col items-center bg-white px-2">
            ...
            <span className="text-xs font-extrabold text-black">Selesai</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <p className="font-extrabold text-black text-sm mb-3">Pesanan Telah Selesai</p>
